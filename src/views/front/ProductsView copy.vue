<template>
  ...
  <div class="background-secondary"           data-aos="fade-up-right"
          data-aos-offset="400">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="btn-group d-md-none" role="group">
          <button
            ...
            aria-expanded="false"
          >
            {{ filterCategory ? filterCategory : '所有產品' }}
          </button>
          <ul
        ...
        >
          <ul
            class="list-group d-none d-md-block sticky-md-top"
            style="top: 190px"
          >
            <li
              class="list-group-item list-group-item-action"
        ...
        <div class="col-md-9">
          <ul
            class="row list-unstyled row-cols-1 row-cols-md-2 row-cols-xl-3 g-3"
          >
            <li
              class="col"
              ...
              <div class="products-card position-relative">
                <div class="card p-3">
                  ...
                  <div class="card-body px-0">
                    <h5
                      class="card-title text-start text-primaryDark text-nowrap"
                    >
                      {{ product.title }}
                      <span
                        type="button"
      ...
      <div class="text-center">
        <PaginationComponent :pages="pagination" @change-pages="togglePages" />
      </div>
    </div>
  </div>
</template>
    ...
    filterProducts () {
      return this.products.filter((item) => {
        if (this.filterCategory) {
          console.log(item.category.includes(this.filterCategory))
          return item.category.includes(this.filterCategory)
        }
        return this.products // 呈現全部貼文
      })
    }
  },
  methods: {
